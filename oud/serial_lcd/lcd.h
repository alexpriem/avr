...
#include <stdarg.h>      /* for lcd_printf */
...
#define LCD_BL_PORT      PORTD        /**< pin for backlight mosfet switch */
#define LCD_BL_PIN       5            /**< pin for backlight mosfet switch */
...
extern void lcd_printf(char *fmt, ...);
