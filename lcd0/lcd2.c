...
static uint8_t lcd_read(uint8_t rs) 
{
	...
	*lcd_ddr_db3&=~lcd_b_db3;
	...
	lcd_e_delay();        
	data = 0;
	if ( bit_get(*lcd_p_db0, lcd_b_db0) & lcd_b_db0 ) data |= 0x10;
	if ( bit_get(*lcd_p_db1, lcd_b_db1) & lcd_b_db0 ) data |= 0x20;
	if ( bit_get(*lcd_p_db2, lcd_b_db2) & lcd_b_db0 ) data |= 0x40;
	if ( bit_get(*lcd_p_db3, lcd_b_db3) & lcd_b_db0 ) data |= 0x80;		
	...
	bit_set (*lcd_p_enable, lcd_b_enable);
	lcd_e_delay();
	if ( bit_get(*lcd_p_db0, lcd_b_db0) & lcd_b_db0 ) data |= 0x01;
	if ( bit_get(*lcd_p_db1, lcd_b_db1) & lcd_b_db0 ) data |= 0x02;
	if ( bit_get(*lcd_p_db2, lcd_b_db2) & lcd_b_db0 ) data |= 0x04;
	if ( bit_get(*lcd_p_db3, lcd_b_db3) & lcd_b_db0 ) data |= 0x08;		
	bit_clr (*lcd_p_enable, lcd_b_enable);
...
void init_lcd (uint8_t rs, uint8_t rw, uint8_t enable, uint8_t backlight,
				uint8_t db0, uint8_t db1, uint8_t db2, uint8_t db3 ) 
{
 ...
 db0=db0 & P_PORTMASK;
 if (db0==P_PORTA) {lcd_p_db0=&PORTA; lcd_ddr_db0=&DDRA; DDRA|=lcd_b_db0; }
 if (db0==P_PORTB) {lcd_p_db0=&PORTB; lcd_ddr_db0=&DDRB; DDRB|=lcd_b_db0;}
 if (db0==P_PORTC) {lcd_p_db0=&PORTC; lcd_ddr_db0=&DDRC; DDRC|=lcd_b_db0;}
 if (db0==P_PORTD) {lcd_p_db0=&PORTD; lcd_ddr_db0=&DDRD; DDRD|=lcd_b_db0;}

 db1=db1 & P_PORTMASK;
 if (db1==P_PORTA) {lcd_p_db1=&PORTA; lcd_ddr_db0=&DDRA; DDRA|=lcd_b_db1;}
 if (db1==P_PORTB) {lcd_p_db1=&PORTB; lcd_ddr_db0=&DDRB; DDRB|=lcd_b_db1;}
 if (db1==P_PORTC) {lcd_p_db1=&PORTC; lcd_ddr_db0=&DDRC; DDRC|=lcd_b_db1;}
 if (db1==P_PORTD) {lcd_p_db1=&PORTD; lcd_ddr_db0=&DDRD; DDRD|=lcd_b_db1;}

 db2=db2 & P_PORTMASK;
 if (db2==P_PORTA) {lcd_p_db2=&PORTA; lcd_ddr_db0=&DDRA; DDRA|=lcd_b_db2;}
 if (db2==P_PORTB) {lcd_p_db2=&PORTB; lcd_ddr_db0=&DDRB; DDRB|=lcd_b_db2;}
 if (db2==P_PORTC) {lcd_p_db2=&PORTC; lcd_ddr_db0=&DDRC; DDRC|=lcd_b_db2;}
 if (db2==P_PORTD) {lcd_p_db2=&PORTD; lcd_ddr_db0=&DDRD; DDRD|=lcd_b_db2;}

 db3=db3 & P_PORTMASK;
 if (db3==P_PORTA) {lcd_p_db3=&PORTA; lcd_ddr_db0=&DDRA; DDRA|=lcd_b_db3;}
 if (db3==P_PORTB) {lcd_p_db3=&PORTB; lcd_ddr_db0=&DDRB; DDRB|=lcd_b_db3;}
 if (db3==P_PORTC) {lcd_p_db3=&PORTC; lcd_ddr_db0=&DDRC; DDRC|=lcd_b_db3;}
 if (db3==P_PORTD) {lcd_p_db3=&PORTD; lcd_ddr_db0=&DDRD; DDRD|=lcd_b_db3;}
