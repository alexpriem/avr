...
#define LCD_BL_PORT      LCD_PORT     /**< pin for backlight mosfet switch */
#define LCD_BL_PIN       4            /**< pin for backlight mosfet switch */
...
extern void init_lcd (uint8_t rs, uint8_t rw, uint8_t enable, uint8_t backlight,
